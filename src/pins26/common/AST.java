...
public class AST {
	...
	public static class AttrAST {
		 ...
		 */
		public String head(final Node node, final boolean highlighted) {
			return "";
		}
		 ...
		 * @param node        Vozlisce abstraktnega sintaksnega drevesa.
		 */
		public void desc(final int indent, final Node node, final boolean highlighted) {
			return;
		}
	...
	public static class Logger {
		 ...
		 */
		private void print(final int indent, final Node node, final String text) {
			if (indent > 0)
		 ...
		 */
		private class LoggerVisitor implements FullVisitor<Object, LoggerVisitor.Log> {
			...
			@Override
			public Object visit(final Nodes<? extends Node> nodes, final Log log) {
			...
			@Override
			public Object visit(final FunDef funDef, final Log log) {
			...
			@Override
			public Object visit(final ParDef parDef, final Log log) {
			...
			@Override
			public Object visit(final VarDef varDef, final Log log) {
			...
			@Override
			public Object visit(final Init init, final Log log) {
			...
			@Override
			public Object visit(final ExprStmt exprStmt, final Log log) {
			...
			@Override
			public Object visit(final AssignStmt assignStmt, final Log log) {
			...
			@Override
			public Object visit(final IfStmt ifStmt, final Log log) {
			...
			@Override
			public Object visit(final WhileStmt whileStmt, final Log log) {
			...
			@Override
			public Object visit(final LetStmt letStmt, final Log log) {
			...
			@Override
			public Object visit(final AtomExpr atomExpr, final Log log) {
			...
			@Override
			public Object visit(final UnExpr unExpr, final Log log) {
			...
			@Override
			public Object visit(final BinExpr binExpr, final Log log) {
			...
			@Override
			public Object visit(final VarExpr varExpr, final Log log) {
			...
			@Override
			public Object visit(final CallExpr callExpr, final Log log) {
